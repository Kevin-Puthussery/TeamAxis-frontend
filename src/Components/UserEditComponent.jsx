...
function UserEditComponent({onClose}) {
  return (
    <div className=''>
      


<div id="crud-modal" tabindex="-1" onClick={onClose} aria-hidden="true" class=" flex bg-white/20 backdrop-blur-sm  overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] min-h-full">
            ...
            <form class="p-4 md:p-5">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="email" name="price" id="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="zyz@gmail.com" required=""/>
                    </div>
                    <div class="col-span-2 sm:col-span-1">
